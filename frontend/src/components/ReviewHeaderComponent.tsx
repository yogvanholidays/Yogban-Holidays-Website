        ...
        <div className="grid grid-cols-2 portrait:grid-cols-1  gap-5">
          <div className="flex gap-4 items-center content-center ">
            <a
              ...
              className="items-center content-center justify-center flex" target="_blank" rel="noopener noreferrer"
            >
            ...
            <a
              ...
              className="items-center content-center justify-center flex" target="_blank" rel="noopener noreferrer"
            >
              <img src="google-travel.svg" alt="google travel" className="h-10 " />
            </a>
            <a
